...
for episode in range(n_episodes):
    ...
    while not done:
        ...
        agent.remember(obs["screen"], action, reward, next_obs["screen"], agent.memory_episode)
        agent.remember(obs["screen"], action, reward, next_obs["screen"], agent.memory)
